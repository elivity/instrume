...
class AudioDeviceInfoConverter {
    ...
    /**
     * Converts an integer arrays into a string where each int is separated by a space
     *
     * @param integerArray the integer arrays to convert to a string
     ...
     * @return string which describes the effectType of audio device
     */
