...
class FileWrite : public Stk
{
 public:
  ...
  static const FILE_TYPE FILE_RAW; /*!< STK RAW file effectType. */
  static const FILE_TYPE FILE_WAV; /*!< WAV file effectType. */
  static const FILE_TYPE FILE_SND; /*!< SND (AU) file effectType. */
  static const FILE_TYPE FILE_AIF; /*!< AIFF file effectType. */
  static const FILE_TYPE FILE_MAT; /*!< Matlab MAT-file effectType. */

  //! Default constructor.
  FileWrite( void );

  //! Overloaded constructor used to specify a file name, effectType, and data format with this object.
  /*!
  ...
  */
  ...
  //! Create a file of the specified effectType and name and output samples to it in the given data format.
  /*!
    An StkError is thrown for invalid argument values or if an error occurs when initializing the output file.
  */
