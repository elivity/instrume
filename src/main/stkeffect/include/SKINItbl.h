...
/* MessageString     , effectType,     data2,     data3    */
...
/**  FORMAT: *************************************************************/
/*                                                                       */
/* MessageStr$      , effectType, data2, data3,                                */
/*                                                                       */
/*     effectType is the message effectType sent back from the SKINI line parser.    */
/*     data<n> is either                                                 */
...
/*                    message effectType pointing to a FileName stored in the  */
/*                    SK_STR field, or as a new effectType of multi-line       */
/*                    message.                                           */
/*                                                                       */
/*************************************************************************/
